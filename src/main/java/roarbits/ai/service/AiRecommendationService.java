...
public class AiRecommendationService {
    ...
    public List<String> generateRecommendation(String scheduleJson) {
        ...
        String prompt =
                "사용자 시간표(JSON):\n" +
                        scheduleJson + "\n\n" +
                        "지금 시각 기준으로 한국항공대학교 학생이 공강/빈 시간에 할 수 있는 활동 3가지를 bullet 형식으로 제시해줘.\n" +
                        "- 각 항목은 60자 이내\n" +
                        "- 오직 활동 추천만\n" +
                        "- 실제 장소(학교 앞 식당, 카페, 노래방 등)와 택시팟·밥팟·스터디팟 같은 모임 활동 포함\n" +
                        "- 불필요한 설명이나 메타 정보 없이 바로 행동 추천만 써줘\n"+
                        "단, 사용자의 시간표 데이터를 활용해서 공간/빈 시간을 파악한 후에 추천해.\n" +
                        "다음 문장은 예시야. 절대 복사하지 말고, 이런식으로 작성하라는 뜻이야:\n" +
                        "화요일 오전 9시 수업 전에 택시팟을 모집해보세요~" +
                        "월요일 12:00~13:00 공강! 정석학술정보관 근처에서 덮밥/분식 같이 먹을 사람?" +
